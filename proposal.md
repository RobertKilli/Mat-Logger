...
- [x] **Clinical Persona:** BODY COCKPIT OS AI-protokoller aktivert (v2.1).
...
- [ ] **Exercise Library:** Dedikert visuell database for alle øvelser (v3.0).
...
- [ ] **PB Dashboard:** En "Wall of Fame" for alle dine tyngste løft (v3.0).
